...
parser.add_argument('--config_size', type=str, default='20')
parser.add_argument('--path', type=str, default='/filer/tmp1/dvb30/Dataset - Pritish/')
#parser.add_argument('--path_size', type=str, default='/common/home/spk111/Desktop/Machine-Learning/ML_Project_1/Shreyas/WReN Modified/dataset/')
...
#args.config_path = './results/{}'.format(args.config)
#args.training_path = '{}/{}'.format(args.config, args.config_size)
args.save = './results/{}/{}/checkpoint/'.format(args.config, args.model)
args.log = './results/{}/{}/log/'.format(args.config, args.model)
args.csv = './results/{}/{}/eval.csv'.format(args.config, args.model)
