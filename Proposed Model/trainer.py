...
class Trainer:
    def __init__(self, args):
        ...
        test_path = os.path.join('.', 'results_config_4', self.args.testname)
    ...
    def main(self):
        ...
        if self.args.recovery and os.path.isfile(os.path.join(self.save_path, 'peformance.pickle')):
            ...
            self.test_acc = saved_acc['test_accuracy']
        ...
        while True:
            ...
            if val_acc > best_val_acc:
                ...
                self.test_acc.append(best_val_test_acc)
                ...
                with open(os.path.join(self.save_path, 'peformance.pickle'), 'wb') as f:
                    pickle.dump({'epoch': epoch,
                                 ...
                                 'acc_regime': self.val_acc_regime,
